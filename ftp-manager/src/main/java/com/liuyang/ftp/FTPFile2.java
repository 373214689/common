...
public class FTPFile2 {
    ...
    public FTPFile2(String hostName, int port, String username, String password, String pathName, String fileInfo) throws IOException {
    ...
    public FTPFile2(String pathName, String fileInfo) throws IOException {
